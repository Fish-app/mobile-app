...
import 'package:maoyi/pages/user/user_resetpwd_formdata.dart';
import 'package:maoyi/utils/auth/jwt.dart';
import 'package:maoyi/utils/services/maoyi_rest_client.dart';
import 'package:maoyi/constants/api_path.dart';
import 'package:maoyi/utils/services/storage_service.dart';
...
class AuthService {
  final MaoyiRestClient maoyiRestClient = MaoyiRestClient();
  ...
  Future<void> createUser(
    ...
    try {
      var response = await maoyiRestClient.post(context, createUserEndpoint,
  ...
  Future<void> changePassword(
    ...
    var response = await maoyiRestClient.put(context, changePasswordEndpoint,
  ...
  Future<bool> loginUser(
    ...
    var response = await maoyiRestClient.post(context, loginUserEndpoint,
